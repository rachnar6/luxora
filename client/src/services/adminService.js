...
export const getSellerApplications = async (token) => {
  ...
  const { data } = await API.get('/admin/seller-applications', config);
  return data;
};
...
export const approveSellerApplication = async (userId, token) => {
  ...
  const { data } = await API.put(`/admin/seller-applications/${userId}/approve`, {}, config);
  return data;
};
...
export const rejectSellerApplication = async (userId, token) => {
  ...
  const { data } = await API.put(`/admin/seller-applications/${userId}/reject`, {}, config);
  return data;
};
...
export const getSellers = async (token) => {
  ...
  const { data } = await API.get('/admin/sellers', config);
  return data;
};
...
export const updateOrderStatus = async (orderId, status, token) => {
    ...
    const { data } = await API.put(`/orders/${orderId}/status`, { status }, config);
    return data;
};
